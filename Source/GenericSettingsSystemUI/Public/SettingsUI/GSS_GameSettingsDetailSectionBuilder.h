...
#include "GSS_GameSettingsDetailSectionBuilder.generated.h"

class UGSS_GameSetting;
class UGSS_GameSettingsDetailSection;
...
struct GENERICSETTINGSSYSTEMUI_API FGSS_SettingsDetailSectionClasses
{
	...
	TArray<TSoftClassPtr<UGSS_GameSettingsDetailSection>> Sections;
};

/**
 * Maps GSS runtime setting classes to detail Sections for UGSS_GameSettingsDetailView.
 * 将 GSS 运行时设置类映射到 UGSS_GameSettingsDetailView 的详情 Section。
 *
...
class GENERICSETTINGSSYSTEMUI_API UGSS_GameSettingsDetailSectionBuilder : public UGUIS_DetailSectionsBuilder
{
	GENERATED_BODY()
...
public:
	...
	TArray<TSoftClassPtr<UGSS_GameSettingsDetailSection>> GetSectionsForSetting(const UGSS_GameSetting* Setting) const;
