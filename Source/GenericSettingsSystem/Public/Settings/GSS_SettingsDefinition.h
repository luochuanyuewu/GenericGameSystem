...
#include "GSS_SettingsDefinition.generated.h"

class UGSS_GameSetting;
class UGSS_SettingsBuilder;
class UGSS_SettingEditCondition;
...
class GENERICSETTINGSSYSTEM_API UGSS_SettingDefinition : public UObject
{
	GENERATED_BODY()
...
class GENERICSETTINGSSYSTEM_API UGSS_CollectionSettingDefinition : public UGSS_SettingDefinition
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, Instanced, BlueprintReadOnly, Category = "GSS|Settings")
	TArray<TObjectPtr<UGSS_SettingDefinition>> Children;
...
UCLASS(BlueprintType, EditInlineNew)
class GENERICSETTINGSSYSTEM_API UGSS_BoolSettingDefinition : public UGSS_SettingDefinition
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, EditInlineNew)
class GENERICSETTINGSSYSTEM_API UGSS_DiscreteSettingDefinition : public UGSS_SettingDefinition
{
	GENERATED_BODY()
...
UCLASS(BlueprintType, EditInlineNew)
class GENERICSETTINGSSYSTEM_API UGSS_ActionSettingDefinition : public UGSS_SettingDefinition
{
	GENERATED_BODY()
...
class GENERICSETTINGSSYSTEM_API UGSS_SettingsDefinitionAsset : public UPrimaryDataAsset
{
	GENERATED_BODY()

public:
	/** Builds every root definition using Builder. / 使用 Builder 构建全部根 Definition。 */
	void Build(UGSS_SettingsBuilder* Builder) const;

	/** Root nodes in display/build order. / 按显示与构建顺序排列的根节点。 */
	UPROPERTY(EditAnywhere, Instanced, BlueprintReadOnly, Category = "GSS|Settings")
	TArray<TObjectPtr<UGSS_SettingDefinition>> RootSettings;
};
