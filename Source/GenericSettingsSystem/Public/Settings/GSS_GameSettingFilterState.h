 ...
 */
class GENERICSETTINGSSYSTEM_API FGSS_GameSettingEditableState
{
public:
 ...
 * visibility.
 */
class GENERICSETTINGSSYSTEM_API FGSS_GameSettingEditCondition : public TSharedFromThis<FGSS_GameSettingEditCondition>
{
public:
	FGSS_GameSettingEditCondition() { }
	virtual ~FGSS_GameSettingEditCondition() { }

	DECLARE_EVENT_OneParam(FGSS_GameSettingEditCondition, FOnEditConditionChanged, bool);
	...
	virtual void SettingApplied(const ULocalPlayer* InLocalPlayer, UGSS_GameSetting* Setting) const
	{
	}

	/** Called when the setting is changed. */
	virtual void SettingChanged(const ULocalPlayer* InLocalPlayer, UGSS_GameSetting* Setting, EGSS_GameSettingChangeReason Reason) const
	{
	}
	 ...
	 */
	virtual void GatherEditState(const ULocalPlayer* InLocalPlayer, FGSS_GameSettingEditableState& InOutEditState) const
	{
	}
