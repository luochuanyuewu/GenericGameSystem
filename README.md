...
- **Features**:
  ...
  - Data Asset authoring plus Local/Shared reflected accessors for Blueprint/C++ targets. Scalar definitions and `AddScalar` can select a built-in display format such as raw, percent, or integer.
